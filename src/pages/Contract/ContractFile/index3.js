  ...
  const AmortizationTable = ({ totalAmount, biWeeklyPayment, payedAmount }) => {
    ...
    return (
      tableRows?.map((item, index) => {
        return (
          <Row key={index}>
            <Cell x={2.625} y={0.47} centered><CellText bold size={9}>12/03/2023</CellText></Cell>
            <Cell x={2.625} y={0.47} centered><CellText bold size={9}>{item[0]}</CellText></Cell>
            <Cell x={2.625} y={0.47} centered><CellText bold size={9}>{item[1]}</CellText></Cell>
            <Cell x={2.625} y={0.47} centered><CellText bold size={9}>{item[2]}</CellText></Cell>
            <Cell x={2.625} y={0.47} centered><CellText bold size={9}>{item[3]}</CellText></Cell>
            <Cell x={2.625} y={0.47} centered><CellText bold size={9}>{item[4]}</CellText></Cell>
            <Cell x={2.625} y={0.47} centered><CellText bold size={9}>{item[5]}</CellText></Cell>
            <Cell x={2.625} y={0.47} centered><CellText bold size={9}>{item[6]}</CellText></Cell>
          </Row>
        )
      }
      )
      ...
      <Page size="A4" style={ui.page}>
        ...
        <SubNumbers subnumber="I.">
          <Parraf>
            ...
            mediante el cual el Acreditado se obligó a entregar al Acreditante la cantidad total de $[la cantidad quincenal x 4].00 M.N.
